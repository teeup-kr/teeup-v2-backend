...
from .enums import (
    UserStatus, Provider, Gender, HandicapUpdateMethod, TokenRevokeReason
)
...
class User(Base):
    ...
    handicap_update_method = Column(Enum(HandicapUpdateMethod), default=HandicapUpdateMethod.MANUAL, comment="핸디캡 업데이트 방식")
